...
min(bitcoin$spread)
max(bitcoin$spread)
mean(bitcoin$close_ratio)
median(bitcoin$close_ratio)
var(bitcoin$close_ratio)
...
min(ethereum$spread)
max(ethereum$spread)
mean(ethereum$close_ratio)
median(ethereum$close_ratio)
var(ethereum$close_ratio)
...
min(litecoin$spread)
max(litecoin$spread)
mean(litecoin$close_ratio)
median(litecoin$close_ratio)
var(litecoin$close_ratio)
```
